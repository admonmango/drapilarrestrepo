...
<div class="course-results-progress">
	<div class="items-progress">
		...
		<span
			class="number"><?php printf( '%1$d/%2$d', $course_results['items']['lesson']['completed'], $course_results['items']['lesson']['total'] ); ?></span>

		<div class="learn-press-progress lp-course-progress">
			<div class="progress-bg lp-progress-bar">
				<?php
				$lessons_complete_percent = Maxcoach_Helper::calculate_percentage( $course_results['items']['lesson']['completed'], $course_results['items']['lesson']['total'] );
				?>
				<div class="progress-active lp-progress-value" style="left: <?php echo $lessons_complete_percent; ?>%;">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="items-progress">
		...
		<div class="learn-press-progress lp-course-progress">
			<div class="progress-bg lp-progress-bar">
				<?php
				$lessons_complete_percent = Maxcoach_Helper::calculate_percentage( $course_results['items']['quiz']['completed'], $course_results['items']['quiz']['total'] );
				?>
				<div class="progress-active lp-progress-value" style="left: <?php echo $lessons_complete_percent; ?>%;">
				</div>
			</div>
