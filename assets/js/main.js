(
	function( $ ) {
		...
		if(document.querySelector(".product-quantity")){
		   document.querySelector(".product-quantity").innerHTML = 'Cantidad';
			document.querySelector(".product-price").innerHTML = 'Precio';
			document.querySelector(".coupon .button").innerHTML = 'Aplicar Cupon';
			document.querySelector(".button-text").innerHTML = 'Remover';
			document.querySelector(".button.btn-empty-cart").innerHTML = 'Vaciar carrito';
			document.querySelector(".checkout-button.button.alt.wc-forward").innerHTML = 'Continuar con el proceso de compra ';
		   }
